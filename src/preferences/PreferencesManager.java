...
public class PreferencesManager {
    ...
    private void copyPref(Preferences from, Preferences to) {
        ...
        to.setMDR_COLUMN_DERIVED(from.getMDR_COLUMN_DERIVED());
        to.setMDR_PK_NAME_FORMAT(from.getMDR_PK_NAME_FORMAT());
        to.setMDR_COLUMN_FK_NAME_FORMAT(from.getMDR_COLUMN_FK_NAME_FORMAT());
        to.setMDR_COLUMN_FK_NAME_INDICE_SEP(from.getMDR_COLUMN_FK_NAME_INDICE_SEP());
        ...
        to.setMDR_PARENT_NAME_SEP_FORMAT(from.getMDR_PARENT_NAME_SEP_FORMAT());
        to.setMDR_PARENT_ROLE_NAME_SEP_FORMAT(from.getMDR_PARENT_ROLE_NAME_SEP_FORMAT());
