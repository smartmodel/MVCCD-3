...
public class PreferencesManager {
    ...
    private void copyPref(Preferences from, Preferences to) {
        ...
        to.setMDR_PREF_NAMING_LENGTH_30_REQUIRED(from.getMDR_PREF_NAMING_LENGTH_30_REQUIRED());
        to.setMDR_PREF_NAMING_LENGTH_60_REQUIRED(from.getMDR_PREF_NAMING_LENGTH_60_REQUIRED());
        to.setMDR_PREF_NAMING_LENGTH_120_REQUIRED(from.getMDR_PREF_NAMING_LENGTH_120_REQUIRED());
