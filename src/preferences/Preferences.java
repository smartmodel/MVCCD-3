 ...
 */
  ...
  public static String FETCHER_ORACLE_REQUETE_CONSTRAINT_NAME_NOT_LIKE ="CONSTRAINT_NAME NOT LIKE 'SYS_%'";
  ...
  public static String FETCHER_ORACLE_REQUETE_SQL_USER_TRIGGERS = "SELECT TRIGGER_NAME FROM USER_TRIGGERS";
