...
public class Preferences extends MVCCDElement {
    ...
    public static boolean PERSISTENCE_SERIALISATION_INSTEADOF_XML = false; //ATTENTION: lors de la modification de cette valeur, il faut supprimer le fichier application.pref //TODO-STB: éventuellement supprimer la propriété lorsque la persistance XML est ok.
