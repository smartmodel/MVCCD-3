...
public class SRadioButton extends JRadioButton implements SComponent {
    ...
    public SRadioButton(IPanelInputContent panel){
        super();
        init(panel);
    }
    public SRadioButton(IPanelInputContent panel, JLabel label) {
        super();
        init(panel, label);
    }
