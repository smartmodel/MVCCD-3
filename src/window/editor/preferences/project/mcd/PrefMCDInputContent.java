...
public class PrefMCDInputContent extends PanelInputContent {
  ...
  public void createContentCustom() {
    ...
    btnAIDIndNameDefault.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent actionEvent) {
        fieldAIDIndName.setText(PreferencesManager.instance().profileOrDefault().getMCD_AID_IND_COLUMN_NAME());
      }
    });
    ...
    btnAIDDepNameDefault.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent actionEvent) {
        fieldAIDDepName.setText(PreferencesManager.instance().profileOrDefault().getMCD_AID_DEP_COLUMN_NAME());
      }
    });
    ...
    String sizePrecision = MessagesBuilder.getMessagesProperty(Preferences.MCDDATATYPE_NUMBER_SIZE_PRECISION);
    fieldDatatypeSizeMode.addItem(sizePrecision);
    String sizeOnlyInteger = MessagesBuilder.getMessagesProperty(Preferences.MCDDATATYPE_NUMBER_SIZE_INTEGER_PORTION_ONLY);
    ...
    String textName = MessagesBuilder.getMessagesProperty(Preferences.MCD_NAMING_NAME);
    fieldTreeNamingAssociation.addItem(textName);
    String textShortName = MessagesBuilder.getMessagesProperty(Preferences.MCD_NAMING_SHORT_NAME);
  ...
  public boolean checkDatasPreSave(SComponent sComponent) {
    ...
    if (fieldAIDWithDep.isSelected()) {
      ...
      unitaire = notBatch && ((sComponent == fieldAIDIndName) || (sComponent == fieldAIDDepName));
  ...
  public void saveDatas(MVCCDElement mvccdElement) {
    ...
    if (fieldDatatypeSizeMode.checkIfUpdated()) {
      ...
      String sizePrecision = MessagesBuilder.getMessagesProperty(Preferences.MCDDATATYPE_NUMBER_SIZE_PRECISION);
      String sizeInteger = MessagesBuilder.getMessagesProperty(Preferences.MCDDATATYPE_NUMBER_SIZE_INTEGER_PORTION_ONLY);
    ...
    if (fieldTreeNamingAssociation.checkIfUpdated()) {
      ...
      String namingName = MessagesBuilder.getMessagesProperty(Preferences.MCD_NAMING_NAME);
      String namingShortName = MessagesBuilder.getMessagesProperty(Preferences.MCD_NAMING_SHORT_NAME);
