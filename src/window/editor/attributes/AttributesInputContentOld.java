...
public class AttributesInputContentOld extends PanelInputContent {
    ...
    public AttributesInputContentOld(AttributesInput attributesInput)    {
    ...
    private void  makeLayout(){
        ...
        panelTable.setPreferredSize(
                new Dimension(table.getWidth(), 20));
