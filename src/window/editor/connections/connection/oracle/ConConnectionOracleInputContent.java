...
public class ConConnectionOracleInputContent extends ConConnectionInputContent {

    public ConConnectionOracleInputContent(ConConnectionOracleInput conResourceOracleInput)     {
