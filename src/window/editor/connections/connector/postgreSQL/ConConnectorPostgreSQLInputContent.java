...
public class ConConnectorPostgreSQLInputContent extends ConConnectorInputContent {

    public ConConnectorPostgreSQLInputContent(ConConnectorPostgreSQLInput conConnectorPostgreSQLInput)     {
        super(conConnectorPostgreSQLInput);
    }


    public ConConnectorPostgreSQLInputContent(MVCCDElement element)     {
        super(element);
    }
