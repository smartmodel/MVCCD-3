...
public class PalettePanel extends JPanel implements Serializable {
  ...
  public PalettePanel() {
    ...
    PaletteButton buttonLink = new PaletteButton(Preferences.DIAGRAMMER_PALETTE_ENTITE_ASSOCIATIVE, PaletteButtonType.RELATION_CREATION, new ImageIcon("ressources/icons-diagrammer/palette/icon_association_class.png"));
