...
public abstract class RelationShape extends JComponent implements IShape, Serializable {
    ...
    public void drag(int differenceX, int differenceY) {
        // Déplace l'ensemble des points d'ancrage constituant la relation
        for (RelationAnchorPointShape p : this.anchorPoints) {
            p.setLocationDifference(differenceX, differenceY);
        }
        // Déplace les labels
        for (LabelShape label : this.labels) {
            label.setLocationDifference(differenceX, differenceY);
        }
    }
    ...
    public RelationAnchorPointShape convertPoint2DToAnchorPoint(Point2D point2D) {
        return new RelationAnchorPointShape((int) point2D.getX(), (int) point2D.getY(), this);
    }
    ...
    public void addAnchorPoint(Point point) {
        ...
        if (nearestSegment != null) {
            ...
            RelationAnchorPointShape newAnchorPoint = new RelationAnchorPointShape(nearestPointOnSegment, newIndex, this);
    ...
    public Line2D getNearestSegment(Point point) {
        ...
        return null;
/*        Line2D segmentToReturn = this.getSegments().get(0);
        for (Line2D segment : this.getSegments()) {
            if (ShapeUtils.getDistanceBetweenLineAndPoint(segment, point) < ShapeUtils.getDistanceBetweenLineAndPoint(segmentToReturn, point)) {
    ...
    private void createAnchorPoints(boolean isReflexive) {
        ...
        if (isReflexive) {
            RelationAnchorPointShape p1 = new RelationAnchorPointShape((int) this.source.getBounds().getMaxX() - MARGIN, (int) this.source.getBounds().getMinY(), 0, this);
            RelationAnchorPointShape p2 = new RelationAnchorPointShape((int) this.source.getBounds().getMaxX() - MARGIN, (int) this.source.getBounds().getMinY() - MARGIN, 1, this);
            RelationAnchorPointShape p3 = new RelationAnchorPointShape((int) this.source.getBounds().getMaxX() + MARGIN, (int) this.source.getBounds().getMinY() - MARGIN, 2, this);
            RelationAnchorPointShape p4 = new RelationAnchorPointShape((int) this.source.getBounds().getMaxX() + MARGIN, (int) this.source.getBounds().getMinY() + MARGIN, 3, this);
            RelationAnchorPointShape p5 = new RelationAnchorPointShape((int) this.source.getBounds().getMaxX(), (int) this.source.getBounds().getMinY() + MARGIN, 4, this);
    ...
    public void generateAnchorPointWhenDestinationIsRelationShape() {
        ...
        this.anchorPoints.add(new RelationAnchorPointShape(this.source.getX(), this.source.getY(), 0, this));
        RelationAnchorPointShape anchorPointOnDestinationRelation = new RelationAnchorPointShape(this.destination.getCenter().x, this.destination.getCenter().y, 1, this);
    ...
    public void generateAnchorPoints() {
        ...
        if (sourcePosition == Position.BOTTOM_CENTER_RIGHT) {
            ...
            this.anchorPoints.add(new RelationAnchorPointShape(x, (int) sourceBounds.getMinY(), 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape(x, (int) destBounds.getMaxY(), 1, this));
            ...
            x = (int) (sourceBounds.getMinX() + ((destBounds.getMaxX() - sourceBounds.getMinX()) / 2));
            this.anchorPoints.add(new RelationAnchorPointShape(x, (int) sourceBounds.getMaxY(), 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape(x, (int) destBounds.getMinY(), 1, this));
            ...
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getMaxX(), y, 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMinX(), y, 1, this));
            ...
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getMinX(), y, 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMaxX(), y, 1, this));
        } else if (sourcePosition == Position.RIGHT_CENTER_BOTTOM) {
            y = (int) (sourceBounds.getMinY() + ((destBounds.getMaxY() - sourceBounds.getMinY()) / 2));
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getMinX(), y, 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMaxX(), y, 1, this));
        } else if (sourcePosition == Position.TOP_CORNER_RIGHT) {
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) sourceBounds.getMaxY(), 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) destBounds.getCenterY(), 1, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMaxX(), (int) destBounds.getCenterY(), 2, this));
        } else if (sourcePosition == Position.TOP_CORNER_LEFT) {
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) sourceBounds.getMaxY(), 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) destBounds.getCenterY(), 1, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMinX(), (int) destBounds.getCenterY(), 2, this));
        } else if (sourcePosition == Position.BOTTOM_CORNER_RIGHT) {
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) sourceBounds.getMinY(), 0, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getCenterX(), (int) destBounds.getCenterY(), 1, this));
            this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMaxX(), (int) destBounds.getCenterY(), 2, this));
            ...
            if (sourceBounds.intersects(destBounds)) {
                this.anchorPoints.add(new RelationAnchorPointShape((int) sourceBounds.getMaxX(), (int) sourceBounds.getCenterY(), 0, this));
                this.anchorPoints.add(new RelationAnchorPointShape((int) destBounds.getMaxX(), (int) destBounds.getCenterY(), 0, this));
            }
        }
    }
