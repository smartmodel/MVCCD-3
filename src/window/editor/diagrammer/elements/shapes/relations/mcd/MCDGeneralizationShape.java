/***
 * Cette classe peut être utilisée en l'état actuel. Elle représente l'objet graphique d'une généralisation MCD.
...
public class MCDGeneralizationShape extends RelationShape implements Serializable {
  ...
  public void drawArrow(Graphics2D graphics2D) {
    ...
    final int ARROW_WIDTH = (int) UIUtils.getGeneralizationArrowWidth();
    final int ARROW_HEIGHT = (int) UIUtils.getGeneralizationArrowHeight();
