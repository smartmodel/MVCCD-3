...
public class RelationAnchorPointShape extends Point implements IShape, Serializable {
    ...
    private RelationShape parent;
    private int index;
    private boolean isSelected = false;
    private int id;

    public RelationAnchorPointShape(Point p, int index, RelationShape parent) {
        super(p);
    ...
    public RelationAnchorPointShape(int x, int y, RelationShape parent) {
        super(x, y);
        this.parent = parent;
        this.generateId();
        this.setSize(Preferences.DIAGRAMMER_DEFAULT_ANCHOR_POINT_SIZE, Preferences.DIAGRAMMER_DEFAULT_ANCHOR_POINT_SIZE);
    ...
    public RelationAnchorPointShape(int x, int y, int index, RelationShape parent) {
        super(x, y);
        this.generateId();
        this.index = index;
        this.setSize(Preferences.DIAGRAMMER_DEFAULT_ANCHOR_POINT_SIZE, Preferences.DIAGRAMMER_DEFAULT_ANCHOR_POINT_SIZE);
    ...
    public RelationAnchorPointShape(int id, Point p, int index, RelationShape parent) {
        super(p);
        this.id = id;
        this.index = index;
        this.parent = parent;
    ...
    public RelationShape getParent() {
        return this.parent;
    }

    public void setParent(RelationShape parent) {
        this.parent = parent;
    }
}