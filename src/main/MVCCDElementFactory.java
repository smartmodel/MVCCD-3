...
import mpdr.tapis.oracle.MPDROracleColumnJnal;
...
public class MVCCDElementFactory {
  ...
  public MDRContDiagrams createMDRDiagrams(ProjectElement parent, int id) {
    return new MDRContDiagrams(parent, id);
  }

  public MDRContDiagrams createMDRDiagrams(ProjectElement parent) {
    return new MDRContDiagrams(parent);
  }

  public MDRContDiagrams createMDRDiagrams(ProjectElement parent, String name) {
    return new MDRContDiagrams(parent, name);
  }
  ...
  public MCDDiagram createMPDRDiagram(ProjectElement parent, String name) {
    return new MCDDiagram(parent, name);
  }
  ...
  private void createMLDRContModel(MLDRModel mldrModel) {
    ...
    new MLDRContDiagrams(mldrModel, Preferences.REPOSITORY_MCD_DIAGRAMS_NAME);
  }
  ...
  public MPDROracleColumnJnal createMPDROracleColumnJnal(MDRContColumns mdrContColumns, MPDRConstraintCustomJnal mpdrConstraintCustomJnal, Stereotype stereotype) {
  ...
  public MPDROracleColumnJnal createMPDROracleColumnJnal(MDRContColumns mdrContColumns, MPDRColumn mpdrColumnSource) {
  ...
  private void createMPDRContModel(MPDRModel mpdrModel) {
    ...
    new MPDRContDiagrams(mpdrModel, Preferences.REPOSITORY_MCD_DIAGRAMS_NAME);
  }
