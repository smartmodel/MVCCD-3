    ...
    public WinRepositoryTree(DefaultTreeModel treeModel) {
        ...
        MouseAdapter ma = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (clickedNode != null) {
                    // Code pour l'ouverture du diagramme MCD et MLD
                    ...
                    // Code pour l'ouverture du diagramme MPD
                    if (clickedNode.getUserObject() instanceof MPDRDiagram) {
                        if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e) && !e.isConsumed()) {
                            e.consume();
                            DiagrammerService.getDrawPanel().unloadAllShapes();
                            Diagram diagramClicked = (Diagram) clickedNode.getUserObject();
            ...
            public void mousePressed(MouseEvent e) {
                ...
                TreeNode abstractionTypeNode = null;

                // Pour récupérer le noeud parent de la feuille sur laquelle on a cliquée
                try {
                ...
                // Pour récupérer le noeud grand-père de la feuille sur laquelle on a cliquée
                try {
                    abstractionTypeNode = this.node.getParent().getParent();
                } catch (NullPointerException nullPointerException) {
                    abstractionTypeNode = null;
                }

                if (abstractionTypeNode != null && abstractionTypeNode.toString().equals("MPDR_Oracle")) {
                    TransferHandler handler = c.getTransferHandler();
                    handler.exportAsDrag(c, e, TransferHandler.COPY); // Le TransferHandler.COPY -> copie l'élément
                }
            }
