...
public abstract class MDRTable extends MDRTableOrView {
  ...
  public MDRPK getMDRPK() {
    ...
    throw new CodeApplException(
        "La table  " + this.getNamePath() + "retourne : " + resultat.size() + " PK.");
  }
  ...
  public MDRConstraintCustomSpecialized getMDRConstraintCustomSpecialized() {
    ...
    throw new CodeApplException("La table  " + this.getNamePath() + "retourne : " + resultat.size()
        + " ConstraintCustomSpcialized.");
  }
  ...
  public MDRColumn getMDRColumnPKProper() {
    ...
    throw new CodeApplException(
        "La table  " + this.getNamePath() + "retourne : " + mdrColumnsPKProper.size()
            + " colonnes PK propres.");
