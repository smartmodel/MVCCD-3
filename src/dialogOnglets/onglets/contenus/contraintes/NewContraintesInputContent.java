...
import window.editor.mcd.operation.constraint.constraints.ConstraintsTableColumn;
...
public class NewContraintesInputContent  extends PanelInputContentTable {

    public NewContraintesInputContent(NewContraintesInput newContraintesInput)    {

        super(newContraintesInput);
    }
    ...
    protected void specificInitOrLoadTable() {
        ...
        MCDContConstraints mcdContConstraints = mcdEntity.getMCDContConstraints();
