...
public class NewRelationsInputContent extends PanelInputContentTable {


    public NewRelationsInputContent(NewRelationsInput newRelationsInput) {
        super(newRelationsInput);
    }
