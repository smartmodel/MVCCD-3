...
public class AttributesTableModel extends AbstractTableModel {
    ...
    //Tableau 2d qui va contenir les attributs
    private static Object[][] attributesTab;

    /**
     * Constructeur : reçoit tableau d'attributs en paramètre et le stocke en local
     */
    AttributesTableModel(Object[][] data) {
        AttributesTableModel.attributesTab = data;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        return attributesTab[rowIndex][columnIndex];
    }
}