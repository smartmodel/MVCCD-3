...
/**
 * L'instance correspond au modèle "MCD" existant dans le référentiel. Ce modèle MCD contient potentiellement lui-même plusieurs modèles (MLDR).
 */
public class MCDContModels extends MCDElement implements IMCDModel, /*IMCDNamePathParent, */IMCDContPackages, IMCDContContainer, IMCDCompliant, IMPathOnlyRepositoryTree {
  ...
  public MLDRModel getLastTransformedMLDRModel() {
    return this.lastTransformedMLDRModel;
  }
