...
public enum MPDREnumColumnsAudit {
    AJ_USER_ORACLE(MPDRDB.ORACLE, Preferences.MPDR_COLUMN_AUDIT_AJUSER_NAME, Preferences.STEREOTYPE_AUDIT_AJUSER_LIENPROG,
    ...
    AJ_DATE_ORACLE(MPDRDB.ORACLE, Preferences.MPDR_COLUMN_AUDIT_AJDATE_NAME, Preferences.STEREOTYPE_AUDIT_AJDATE_LIENPROG,
            Preferences.MPDRORACLEDATATYPE_TIMESTAMP_LIENPROG, null,
            Preferences.MCDDATATYPE_DATETIME_LIENPROG),
    MO_USER_ORACLE(MPDRDB.ORACLE, Preferences.MPDR_COLUMN_AUDIT_MOUSER_NAME, Preferences.STEREOTYPE_AUDIT_MOUSER_LIENPROG,
            Preferences.MPDRORACLEDATATYPE_VARCHAR2_LIENPROG, Preferences.MPDRORACLE_USER_NAME_SIZE,
            Preferences.MCDDATATYPE_WORD_LIENPROG),
    MO_DATE_ORACLE(MPDRDB.ORACLE, Preferences.MPDR_COLUMN_AUDIT_MODATE_NAME, Preferences.STEREOTYPE_AUDIT_MODATE_LIENPROG,
            Preferences.MPDRORACLEDATATYPE_TIMESTAMP_LIENPROG, null,
            Preferences.MCDDATATYPE_DATETIME_LIENPROG);
