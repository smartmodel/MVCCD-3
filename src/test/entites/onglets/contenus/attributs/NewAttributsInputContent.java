...
import window.editor.mcd.attributes.AttributesTableColumn;

import java.awt.*;
import java.util.ArrayList;

public class NewAttributsInputContent extends PanelInputContentTable {

    public NewAttributsInputContent(NewAttributsInput attributsInput)    {

        super(attributsInput);
    }
    ...
    protected void specificInitOrLoadTable() {
        ...
        MCDContAttributes mcdContAttributes = mcdEntity.getMCDContAttributes();
    ...
    protected MElement newElement() {
        ...
        MCDEntity mcdEntity = (MCDEntity) getEditor().getMvccdElementCrt();
        MCDContAttributes mcdContAttribute = mcdEntity.getMCDContAttributes();
