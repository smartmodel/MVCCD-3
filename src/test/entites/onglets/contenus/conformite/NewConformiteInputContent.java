...
public class NewConformiteInputContent extends PanelInputContent {
    ...
    public NewConformiteInputContent(NewConformiteInput newConformiteInput)     {
        super(newConformiteInput);
    }

    public NewConformiteInputContent(MVCCDElement element)     {
        super(null);
    ...
    public void loadDatas(MVCCDElement mvccdElementCrt) {
        ...
        ((EntiteOngletsTreat) getEditor().getEditingTreat()).treatCompliant(getEditor(), mcdEntity);
