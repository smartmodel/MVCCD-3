...
public class NewMldrInputContent  extends PanelInputContent {

    private JLabel labelMLDRTableName;
    private STextField fieldMLDRTableName;

    public NewMldrInputContent(NewMldrInput newMldrInput)     {
        super(newMldrInput);
    }

    public NewMldrInputContent(MCDEntity mcdEntity)     {
        super(null);
        elementForCheckInput = mcdEntity;
    }
